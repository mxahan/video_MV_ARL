...
if __name__ == "__main__":
    ...
    if pretrain_ == 1:
        wt = torch.load("../../../Saved_models/R2PLUS1D_16x4_R50.pyth")
...
# Hooking: https://web.stanford.edu/~nanbhas/blog/forward-hooks-pytorch/
...
class MultiTaskModel(nn.Module):
    ...
    def __init__(self, arch,ps=0.5):
        ...
        self.encoder = arch      #fastai function that creates an encoder given an architecture
        self.fc1 = nn.Linear(2048,1000)    #fastai function that creates a head
